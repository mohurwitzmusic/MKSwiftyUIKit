...
/// Adds itself as its delegate and uses closures for callbacks.

open class MKSwiftySetupUITextField: UITextField, UITextFieldDelegate {
...
public extension MKSwiftySetupUITextField {
